...
public class ArticleServiceImpl implements ArticleService {
    ...
    public ArticleDto createArticle(ArticleDto article, AuthUserDetails authUserDetails) {
        String slug = String.join("-", article.getTitle().split(" ")).toLowerCase();
    ...
    public ArticleDto unfavoriteArticle(String slug, AuthUserDetails authUserDetails) {
        Long articleId = articleRepository.findBySlug(slug)
                ...
                .getId();
        FavoriteEntity favorite = favoriteRepository.findByArticleIdAndUserId(articleId, authUserDetails.getId())
    ...
    @Override
    public long getArticlesCount(ArticleQueryParam articleQueryParam) {
        if (articleQueryParam.getTag() != null) {
            return articleRepository.countByTagList_Tag(articleQueryParam.getTag());
        } else if (articleQueryParam.getAuthor() != null) {
            return articleRepository.countByAuthor_Username(articleQueryParam.getAuthor());
        } else if (articleQueryParam.getFavorited() != null) {
            return articleRepository.countByFavoritedUsername(articleQueryParam.getFavorited());
        } else {
